---
title: Explore These Interactive COVID-19 Charts to Gain Insights On It's Impact
author: Jojo Abalos
date: '2020-04-25'
slug: explore-these-interactive-covid-19-charts-to-gain-insights-on-it-s-impact
categories:
  - R
tags:
  - R
...
summary: ''
authors: []
lastmod: '2020-04-25T00:54:51+08:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
The plots below are created using the [COVID-19 dataset](https://raw.githubusercontent.com/datasets/covid-19/master/data/countries-aggregated.csv) published and updated daily by [Johns Hopkins University](https://www.jhu.edu/) on COVID-19 cases worldwide. Feel free to play around with the interactive plots below. You may be able to find some interesting insights on how each of these countries are affected and how they are faring in relation to others.
...
```{r fig.width=7.5, fig.height=7.5, fig.align="center", message=FALSE, echo=FALSE}
plotly::ggplotly(p2) %>%
  layout(title = list(text = paste0('Covid-19 Top 12 Countries by Cumulative Cases',
                                    '<br>',
                                    '<sup>',
