...
The plots below are created using the datasets published and updated daily by Johns Hopkins University on COVID-19 cases worldwide.  Feel free to play around with the interactive plots below of the Top12 Countries with the most number of cumulative confirmend cases of COVID-19 to date.  You may be able to find some interesting insights on how each of these countries are affected.
